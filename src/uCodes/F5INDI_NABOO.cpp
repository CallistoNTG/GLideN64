...
//		float SX = vtx.x / vtx.w * gSP.viewport.vscale[0] + gSP.viewport.vtrans[0];
//		float SY = vtx.y / vtx.w * gSP.viewport.vscale[1] + gSP.viewport.vtrans[1];
//		float SZ = vtx.z / vtx.w * gSP.viewport.vscale[2] + gSP.viewport.vtrans[2];
//		DebugMsg(DEBUG_NORMAL, "vtx[%d]: x=%.4f y=%.4f z=%.4f\n", i, SX, SY, SZ);
